...
use DFZ\Dola\FormFields\After\HandlerInterface as AfterHandlerInterface;
use DFZ\Dola\FormFields\HandlerInterface;
use DFZ\Dola\Models\Category;
use DFZ\Dola\Models\DataRow;
use DFZ\Dola\Models\DataType;
use DFZ\Dola\Models\Menu;
use DFZ\Dola\Models\MenuItem;
use DFZ\Dola\Models\Page;
use DFZ\Dola\Models\Permission;
use DFZ\Dola\Models\Post;
use DFZ\Dola\Models\Role;
use DFZ\Dola\Models\Setting;
...
class Dola
{
    ...
    {
        if (!empty($file) && Storage::disk(config('dola.storage.disk'))->exists($file)) {
            return Storage::disk(config('dola.storage.disk'))->url($file);
        }
    ...
    {
        require __DIR__.'/../routes/dola.php';
    }
    ...
    {
        if (!config('dola.multilingual.enabled')) {
            return false;
        }
