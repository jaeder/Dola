...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'dola:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Dola.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/dfz/dola/src/Http/Controllers'));
        $namespace = config('dola.controllers.namespace', 'DFZ\\Dola\\Http\\Controllers');
        ...
        $this->info('Published Dola controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/dfz/dola/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'DFZ\\Dola\\Http\\Controllers\\'.$class,
            $content
        );
