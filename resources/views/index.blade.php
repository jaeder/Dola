...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ dola_asset('css/ga-embed.css') }}">
@stop

@section('content')
    <div class="page-content">
        @include('dola::alerts')
        @include('dola::dimmers')
        <div style="padding:15px;">
            <?php $google_analytics_client_id = Dola::setting("google_analytics_client_id"); ?>
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script src="{{ dola_asset('js/ga-embed/chart.min.js') }}"></script>
        <script src="{{ dola_asset('js/ga-embed/moment.min.js') }}"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="{{ dola_asset('js/ga-embed/view-selector2.js') }}"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="{{ dola_asset('js/ga-embed/date-range-selector.js') }}"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="{{ dola_asset('js/ga-embed/active-users.js') }}"></script>
