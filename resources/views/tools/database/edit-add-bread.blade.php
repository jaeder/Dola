...
@section('page_header')
    <div class="page-title">
        <i class="dola-data"></i> @if(isset($dataType->id)){{ 'Edit BREAD for ' . $dataType->name . ' table' }}@elseif(isset($table)){{ 'Create BREAD for ' . $table . ' table' }}@endif
    </div>
    @php
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="@if(isset($dataType->id)){{ route('dola.database.bread.update', $dataType->id) }}@else{{ route('dola.database.bread.store') }}@endif"
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                @if(isset($dataType->id))
                                    <?php $dataRow = DFZ\Dola\Models\DataRow::where('data_type_id', '=',
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        @else
                                            <select name="field_input_type_{{ $data['field'] }}">
                                                @foreach (Dola::formFields() as $formField)
