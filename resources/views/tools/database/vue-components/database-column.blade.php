...
<tr class="newTableRow">
    ...
    <td>
        <div class="btn btn-danger delete-row" @click="deleteColumn"><i class="dola-trash"></i></div>
    </td>
...
@include('dola::tools.database.vue-components.database-types')
@include('dola::tools.database.vue-components.database-column-default')
