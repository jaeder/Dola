...
@section('content')
    <div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('dola.posts.update', $dataTypeContent->id) }}@else{{ route('dola.posts.store') }}@endif" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="dola-character"></i> Post Title
                                <span class="panel-desc"> The title for your post</span>
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action dola-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <div class="panel-actions">
                                <a class="panel-action dola-resize-full" data-toggle="panel-fullscreen" aria-hidden="true"></a>
                            </div>
                        </div>
                        @include('dola::multilingual.input-hidden', [
                            '_field_name'  => 'body',
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    @foreach(DFZ\Dola\Models\Category::all() as $category)
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            @if(isset($dataTypeContent->image))
                                <img src="{{ Dola::image( $dataTypeContent->image ) }}" style="width:100%" />
                            @endif
        ...
        <form id="my_form" action="{{ route('dola.upload') }}" target="form_target" method="post" enctype="multipart/form-data" style="width:0px;height:0;overflow:hidden">
            {{ csrf_field() }}
...
@section('javascript')
    ...
    <script src="{{ dola_asset('js/slugify.js') }}"></script>
@stop
