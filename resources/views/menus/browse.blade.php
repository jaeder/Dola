...
@section('page_header')
    <h1 class="page-title">
        <i class="dola-list-add"></i> {{ $dataType->display_name_plural }}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        @endif
                                        @if (Dola::can('edit_'.$dataType->name))
                                            <a href="{{ route('dola.'.$dataType->slug.'.builder', $data->id) }}" class="btn-sm btn-success pull-right">
                                                <i class="dola-list"></i> Builder
                                            </a>
                                        @endif
                                    </td>
                                </tr>
