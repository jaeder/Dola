...
class CreateDataTypesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('dola_data_types', function (Blueprint $table) {
            $table->increments('id');
        ...
        // Create table for storing roles
        Schema::create('dola_data_rows', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('dola_data_rows');
        Schema::drop('dola_data_types');
    }
}
